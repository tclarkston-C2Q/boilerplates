      ...
      <Box className="bg-slate-900 rounded-2xl border border-slate-800 p-4 mb-4">
        ...
        <VStack>
          {mockDoctors.map((d) => (
            ...
            >
              <Cell flex={1.4}>
                <Text className="text-xs text-slate-100">{d.name}</Text>
              </Cell>
              <Cell flex={1.4}>
                <Text className="text-xs text-slate-300">{d.specialty}</Text>
              </Cell>
              <Cell>
                <Text className="text-xs text-slate-300">{d.patients}</Text>
              </Cell>
              <Cell>
                {d.onCall ? (
                  <Badge
